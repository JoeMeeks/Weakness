...
var ui_UIService = /*@__PURE__*/ (function () {
    ...
    function UIService(app, platform, events, loadingCtrl, alertCtrl, media, menuCtrl, modalCtrl, toastCtrl, transitions) {
        this.app = app;
        ...
        this.chime = underscore["debounce"](function () {
            try {
                if (!ui_self.audio) {
        ...
        if (sound) {
            ui_self.sound = JSON.parse(sound);
        }
        else {
            ui_self.sound = true;
        }
    ...
    UIService.prototype.load = function () {
        ui_self.audio = new Audio();
        ui_self.audio.src = '../../assets/audio/alert.mp3';
        ui_self.audio.load();
    };
    ...
    UIService.prototype.toggle = function () {
        //self.sound = !self.sound;
        var msg = 'sound: ';
        msg += ui_self.sound ? 'on' : 'off';
        console.info(msg);
        localStorage.setItem('sound', JSON.stringify(ui_self.sound));
    };
    //#region ionic deploy update
    UIService.prototype.download = function (progress) {
        //console.log(progress);
        if (ui_self.progress.download === 0 || progress > ui_self.progress.download) {
            ui_self.progress.download = progress;
            ui_self.loading.show({ text: 'Downloading update\r\n' + ui_self.progress.download + '%' });
        }
    };
    UIService.prototype.extract = function (progress) {
        //console.log(progress);
        if (ui_self.progress.download === 0 || progress > ui_self.progress.extract) {
            ui_self.progress.extract = progress;
        }
        ui_self.loading.show({ text: 'Installing update\r\n' + ui_self.progress.extract + '%' });
    };
    return UIService;
}());
...
var app_component_MyApp = /*@__PURE__*/ (function () {
    function MyApp(events, platform, status, splash, ffxi, ui, mc) {
        ...
        this.json = __webpack_require__(226);
        this.menu = [
            {
                title: "Abyssea",
                items: [
...
var SettingsPage = /*@__PURE__*/ (function () {
    function SettingsPage(view, ffxi, ui) {
        this.view = view;
        this.ffxi = ffxi;
        this.ui = ui;
        settings_vm = this;
...
var app_root = __webpack_require__(58);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/action-sheet/action-sheet-component.ngfactory.js
var action_sheet_component_ngfactory = __webpack_require__(227);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/alert/alert-component.ngfactory.js
var alert_component_ngfactory = __webpack_require__(228);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/app/app-root.ngfactory.js
var app_root_ngfactory = __webpack_require__(229);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/loading/loading-component.ngfactory.js + 1 modules
var loading_component_ngfactory = __webpack_require__(230);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/modal/modal-component.ngfactory.js
var modal_component_ngfactory = __webpack_require__(231);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/picker/picker-component.ngfactory.js + 1 modules
var picker_component_ngfactory = __webpack_require__(232);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/popover/popover-component.ngfactory.js
var popover_component_ngfactory = __webpack_require__(233);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/select/select-popover-component.ngfactory.js + 1 modules
var select_popover_component_ngfactory = __webpack_require__(234);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/toast/toast-component.ngfactory.js
var toast_component_ngfactory = __webpack_require__(235);
...
var menu_ngfactory = __webpack_require__(236);
...
var toolbar_ngfactory = __webpack_require__(89);
...
var nav_ngfactory = __webpack_require__(237);

// EXTERNAL MODULE: ./node_modules/ionic-angular/components/nav/nav.js
var nav_nav = __webpack_require__(62);
...
var util_events = __webpack_require__(66);
...
function View_MyApp_0(_l) {
    return core["_19" /* ɵvid */](0, [(_l()(), core["Z" /* ɵeld */](0, 0, null, null, 32, "ion-menu", [["persistent", "true"], ["role", "navigation"], ["side", "left"], ["type", "push"]], null, [[null, "ionClose"]], function (_v, en, $event) {
            var ad = true;
            var _co = _v.component;
            if (("ionClose" === en)) {
...
var toggle_ngfactory = __webpack_require__(238);
...
var ionic_angular_module = __webpack_require__(190);

// EXTERNAL MODULE: ./node_modules/ionic-angular/navigation/url-serializer.js
var url_serializer = __webpack_require__(60);
...
var picker_controller = __webpack_require__(73);
