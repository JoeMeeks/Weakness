...
var DynamisPage = (function () {
    ...
    //	vm.modal.present();
    //}, 400, true);
    DynamisPage.prototype.switch = function (mode) {
    ...
    DynamisPage.prototype.ionViewWillEnter = function () {
        ...
        vm.type = vm.params.data.type;
        vm.switch();
        vm.events.subscribe('time', function () {
            vm.switch(null);
        });
    };
